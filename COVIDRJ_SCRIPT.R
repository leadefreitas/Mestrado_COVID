# SCRIPT DISSERTACAO LÉA

# chamando as bibliotecas
library(tidyverse) # all tidy packages in one go
library(lubridate) # dealing with dates
library(vroom) # Fast readinf data
library(dplyr)
library(DescTools)
...
#dados.SES.20 <- vroom("http://sistemas.saude.rj.gov.br/tabnetbd/sivep_gripe/sivep_gripe_2020.csv", locale = vroom::locale(encoding = "latin1"))
#dados.SES.21 <- vroom("http://sistemas.saude.rj.gov.br/tabnetbd/sivep_gripe/sivep_gripe_2021.csv", locale = vroom::locale(encoding = "latin1"))
#dados.SES.22 <- vroom("http://sistemas.saude.rj.gov.br/tabnetbd/sivep_gripe/sivep_gripe_2022.csv", locale = vroom::locale(encoding = "latin1"), )
...
#incluindo as regioes de saude

tbl.regsaude <- read_csv("/home/leaamaral/Área de Trabalho/Mestrado/Sincronicidade/Dados/Data_rl_municip_regsaud.csv")
tbl.regsaude <- read_csv("C:/Users/User/Desktop/Mestrado/Sincronicidade/Dados/Data_rl_municip_regsaud.csv")
tbl.regsaude <- read_csv("/home/lbastos/Git/synchronicity/Data/rl_municip_regsaud.csv")
